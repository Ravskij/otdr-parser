...
public final class Constants {
    ...
    public static final int KEY_EVENTS_OFFSET = 86; // Минимальное расстояние между событиями в KeyEvents блоке
    ...
    public static final double REFRACTION_COEFFICIENT = 1.4682; // Коэффициент преломления оптического волокна
